...
Released entries rotated out of [CHANGELOG.md](CHANGELOG.md) to keep the published release description under the 125000 character limit GitHub enforces on release bodies. Newest first.
